...
<!-- [![Watch the demo](./assets/video_thumbnail.png)](https://github.com/ZJU-OmniAI/Embodied-Omni/blob/main/embodied_reasoner/assets/video_v2_en.mov?raw=true) -->
...
> **Note:** Embodied-Reasoner is one project inside the [Embodied-Omni](../README.md) repository.
> All paths and commands below are relative to this directory, so start with
> `cd embodied_reasoner` after cloning.
